...
def add_songs():
    song=ctk.filedialog.askopenfilenames(initialdir='H:\Arnav\Python\Python Workspace\meowsic\\Audio' , title = 'Choose Songs' )
...
#Songs List 
song_list=CTkListbox.CTkListbox(app, width=400 , height =50 , label_text = 'Songs' , fg_color = 'orange' , text_color = 'purple' )
...
#buttons
previous_button= ctk.CTkButton(playback_controls_frame, text='', command= song_previous , image = previous_button_icon, border_width= 0 , fg_color= 'transparent' , hover= False , width=26 , height =26)
previous_button.grid(row=0, column = 0 , padx=10)

play_button = ctk.CTkButton(playback_controls_frame, text='', command=lambda : play_pause(play_button), image=play_button_icon, border_width=0,  fg_color= 'transparent',  hover= False , width=30 , height=30 )
play_button.grid(row=0, column= 1 , padx=10)

next_button= ctk.CTkButton(playback_controls_frame, text='', command= song_next , image = next_button_icon, border_width= 0 , fg_color= 'transparent' , hover= False , width=26 , height =26)
